...
<html>
    ...
    <body>
        ...
        <div class="card">
            <h4 style="padding: 18px; margin-top: 5%;font-family: arial;font-size: 40px;"><i class="fas fa-shopping-cart"></i> My Cart</h4>
            <div class="container">
                  ...
                  <?php 
                        ...
                        if(isset($_SESSION['id'])){
                            ...
                            while ($rows = mysqli_fetch_array($qry)){
                                $total += ($rows['order_price'] * $rows['order_qty']);
                                echo"<div class='item1'>";
                                echo"<img class='productImage' src='".$rows['order_img']."'>  <span style='padding-left: 21%'>".$rows['order_name']." <sup><a href='removeCart.php?cartId=".$rows['id']."'>Remove</a> </sup> </span>";
                                echo"</div>";
                                echo"<div class='item2'>";
                                echo"&#8369; ".number_format((float)$rows['order_price'],2,'.',',')."";
                                echo"</div>";
                                echo"<div class='item' style=' text-align: center;'>";
                                echo"".$rows['order_qty']."";
                                echo"</div>";
                                echo"<div class='item'>";
                                echo"&#8369; ".number_format((float)($rows['order_price'] * $rows['order_qty']),2,'.',',')." ";
                                echo"</div>";
                            }
                            ...
                            if($total != 0){
                                ...
                                echo " <a class='placeOrder'  style='font-size: 30px' href='placeOrder.php'> Place Order</a>";
                                echo " </div>";
                            } else {
                                echo "<div style='height:60%; font-size: 25px;''>";
                                echo "<h3>No products to place order.</h3>";
                                echo "</div>";
                            }
                        } else {
