    ...
    * {font-family: arial;}
    ...
    <body>
        ...
        <div align="center" class="center" style="padding-top: 8%">
            ...
            <h1 align="center" id="he_a" style="font-family: arial;"> LOG IN</h1>
                <table width="500">
                <tr>
                    <td width="127" height="30" align="left"><p id="a_ee" style="font-size: 25px;margin-bottom: 30px;"><b>E-mail:</b></p></td>
                    <td width="400" ><input id="textbox" type="email" name="email" style="width: 120%;" /></td>
                </tr>
                <tr>
                    <td height="30" align="left"><p id="a_pp" style="font-size: 25px;margin-bottom: 30px;"><b>Password:</b></p></td>
                    <td width="400"><input id="passInput" type="password" name="password" style="width: 120%;"/></td>
                </tr>
                <tr>
                    <td height="30" ></td>
                ...
                <tr>
                    <td width="200"><a class="forgot" href="changePass.php" style="font-size: 20px;"><i>  Forgot Password  </i>  </a></td>
                    <td></td>
                </tr>
                <tr align="right">
                    <td> <a class="signUp" href="signUp.php" style="font-size: 25px;"><i>  Sign-up  </i>  </a></td>
                    <td><input style="margin-bottom: 0;" id="submit" type="submit" name="submit" value="Log-in"></td>
                </tr>    
                </table>
