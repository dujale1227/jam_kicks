...
<body>
        ...
        <div class="main">
            <div class="card">
            <h2 style="padding: 9px; margin:0;">Customer List:</h2>
            <div class="search-container">
                        <form action="" style="width: 35%; padding: 30px 16px;float:right;">
                            <input type="text" placeholder="Search Customer Fullname.." id="myInput" style="width: 79%;border: 1px solid #c5c3c3;">
                    ...
                    <div class="container">
                        <?php 
                            ...
                            echo"<div class='product-container'>";
                                    ...
                                    echo"<tr>";
                                    echo"<td> ".$rows['id']."</td>";
                                    echo"<td style='text-transform: capitalize'>  $fullname </td>";
                                    echo"<td> ".$rows['email']."</td>";
                                    echo"<td style='width: 30%'> ".$rows['address']."</td>";
