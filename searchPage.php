        ...
        <div class="product">
            <?php 
             ...
             if(isset($_POST['submit'])){
                $searhValue = $_POST['search'];
                $qry= mysqli_query($con, "SELECT * FROM shoe_items WHERE `name` LIKE '%$searhValue%'");
                $result=mysqli_query($con,"SELECT count(*) as total from shoe_items WHERE `name` LIKE '%$searhValue%'");
                ...
                if( $data['total'] > 0){
                    ...
                    echo "<div class='card'>";
                    echo "<h1 align='center' style='padding-top: 5%'>No Product Result</h1>";
                    echo "</div>";
                }       
             }
            ?>
