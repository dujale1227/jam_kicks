    ...
    <body>
        <ul id="myTopnav" >
            <li class="logo"><img src="./images/logo4.png" alt="" style="width: 9%;height: 62%;"></li>
                ...
                <?php echo "<li class='profile dropdown' style='padding-right: 62%'>" ?>
                <?php 
        ...
        <div align="center" class="center" style="padding-top: 8%">
            ...
            <h1 align="center" id="he_a" style="font-family: arial;"> Change Password</h1>
                <table width="500">
                <tr>
                    <td width="127" height="30" align="left"><p id="a_ee" style="font-size: 25px;margin-bottom: 30px;"><b>E-mail:</b></p></td>
                    <td width="350" ><input id="textbox" type="email" name="email" style="width: 120%;" /></td>
                </tr>
                <tr>
                    <td height="30" align="left">
                        <p id="a_pp" style="font-size: 25px;margin-bottom: 0;"><b>New Password:</b></p>
                        <input type="checkbox" onclick="showPass()" style="height: 14px; width: 36px;"> <span style="font-size: 25px;">Show </span>
                    </td>
                    <td width="350"><input id="passInput" type="password" name="password" style="width: 120%;"/></td>
                </tr>
                <tr>
                    <td height="30" align="left"><p id="a_pp" style="font-size: 25px;margin-bottom: 0;">
                        <b>Confirm Password:</b></p>
                        <input type="checkbox" onclick="showPassConfirm()" style="height: 18px; width: 36px;"> <span style="font-size: 25px;">Show </span>
                    </td>
                    <td width="350"><input id="conpassInput" type="password" name="confirmpassword" style="width: 120%;"/></td>
                </tr>
                <tr align="right">
                        <td></td>
                    <td><input style="width: 70%;" id="submit" type="submit" name="submit" value="Change Password"></td>
...
function showPassConfirm() {
        var x = document.getElementById("conpassInput");
        if (x.type === "password") {
            x.type = "text";
        } else {
            x.type = "password";
